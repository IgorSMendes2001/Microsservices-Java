...
public class PedidoController {
        ...
        public String retornaPorta(@Value("${local.server.port}") String porta){
            return String.format("Requisição respondidapela instância executando na porta %s ",porta);
        }

        @PostMapping()
        public ResponseEntity<PedidoDto> realizaPedido(@RequestBody PedidoDto dto, UriComponentsBuilder uriBuilder) {
